...
public class Minicursos extends AppCompatActivity {
    ListView lvMinicursos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvMinicursos = (ListView) findViewById(R.id.lv_minicursos);
        lvMinicursos.setAdapter(new ListMinicursoAdapter(this, getEventosFromFile()));
    }
    ...
    public List<Evento> getEventosFromFile() {
        ...
        try {
            ...
            if ("en".equals(Locale.getDefault().getLanguage())) {
                imputStrean = this.getAssets().open("minicursos_ingles.json");
            } else {
                imputStrean = this.getAssets().open("minicursos.json");
            }
    ...
    public class ListMinicursoAdapter extends ArrayAdapter<Evento> {
        List<Evento> eventos;

        public ListMinicursoAdapter(Context context, List<Evento> objects) {
